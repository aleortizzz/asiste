-- ============================================================
-- Plantilla visual de la invitación (Clásica / Partiful)
-- Pegar y ejecutar en Supabase → SQL Editor (proyecto "asiste")
--
-- A diferencia de "plan" (que gatea funciones pagas y solo lo toca
-- TizDigital), "template" es una elección de diseño libre del host —
-- se edita desde el mismo formulario del evento, como bg_color.
-- ============================================================
